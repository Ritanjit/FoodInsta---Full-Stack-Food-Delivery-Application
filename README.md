...
<body style="font-family: Arial, sans-serif; text-align: center; background-color: #f8f9fa; color: #333; padding: 20px;">
    ...
    <div style="display: flex; justify-content: center; gap: 20px; align-items: center;">
        ...
        <img src="https://images2.imgbox.com/1b/f7/VZ0DUEw9_o.jpg" alt="Express.js" style="width: 50px; height: auto;">
        <img src="https://images2.imgbox.com/cf/39/OmW0CRcX_o.jpg" alt="React.js" style="width: 50px; height: auto;">
        <img src="https://images2.imgbox.com/47/cc/HcPox1zp_o.jpg" alt="Node.js" style="width: 50px; height: auto;">
    </div>
<!--     <h3>Project Setup Guide</h3>
    <p>This project is available in the <strong>master</strong> branch.</p> -->
</body>
</html>
